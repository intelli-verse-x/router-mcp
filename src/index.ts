...
server.registerTool(
  "create_app",
  {
    ...
    description:
      "Create an app (the entry point for knowledge bases, credit wallets, and per-app cost tracking). " +
...
server.registerTool(
  "create_api_key",
  {
    ...
    description:
      "Mint a tier API key (air | pro | pro_max), optionally bound to an App ID and daily spend limit. " +
