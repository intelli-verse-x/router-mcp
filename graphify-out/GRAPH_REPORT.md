...
## Summary
- 122 nodes · 111 edges · 14 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `83c93006`
...
Cohesion: 0.12
Nodes (16): bin, intelliverse-router-mcp, description, files, license, main, mcpName, name (+8 more)
...
## Knowledge Gaps
- **85 isolated node(s):** `name`, `version`, `description`, `type`, `intelliverse-router-mcp` (+80 more)
...
- **Why does `dependencies` connect `Community 12` to `Community 0`?**
